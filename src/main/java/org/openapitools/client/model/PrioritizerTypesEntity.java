...
public class PrioritizerTypesEntity {
  ...
  private Set<DocumentedTypeDTO> prioritizerTypes = null;


  public PrioritizerTypesEntity prioritizerTypes(Set<DocumentedTypeDTO> prioritizerTypes) {
  ...
  public PrioritizerTypesEntity addPrioritizerTypesItem(DocumentedTypeDTO prioritizerTypesItem) {
    if (this.prioritizerTypes == null) {
      this.prioritizerTypes = new LinkedHashSet<DocumentedTypeDTO>();
    }
