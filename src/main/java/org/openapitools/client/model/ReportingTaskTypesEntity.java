...
public class ReportingTaskTypesEntity {
  ...
  private Set<DocumentedTypeDTO> reportingTaskTypes = null;


  public ReportingTaskTypesEntity reportingTaskTypes(Set<DocumentedTypeDTO> reportingTaskTypes) {
  ...
  public ReportingTaskTypesEntity addReportingTaskTypesItem(DocumentedTypeDTO reportingTaskTypesItem) {
    if (this.reportingTaskTypes == null) {
      this.reportingTaskTypes = new LinkedHashSet<DocumentedTypeDTO>();
    }
