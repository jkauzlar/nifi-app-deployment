...
public class RegistryClientsEntity {
  ...
  private Set<RegistryClientEntity> registries = null;


  public RegistryClientsEntity registries(Set<RegistryClientEntity> registries) {
  ...
  public RegistryClientsEntity addRegistriesItem(RegistryClientEntity registriesItem) {
    if (this.registries == null) {
      this.registries = new LinkedHashSet<RegistryClientEntity>();
    }
